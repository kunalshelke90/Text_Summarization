...
from src.Text_Summarization.pipeline.stage_04_model_trainer import DataModelTrainerTrainingPipeline
from src.Text_Summarization.pipeline.stage_05_model_evualtion import DataModelEvaluationTrainingPipeline
...
try: 
   logger.info(f"*******************")
   logger.info(f">>>>>> stage {STAGE_NAME} started <<<<<<")
   model_trainer = DataModelTrainerTrainingPipeline()
   model_trainer.main()
   logger.info(f">>>>>> stage {STAGE_NAME} completed <<<<<<\n\nx==========x")
except Exception as e:
        logger.exception(e)
...
try: 
   logger.info(f"*******************")
   logger.info(f">>>>>> stage {STAGE_NAME} started <<<<<<")
   model_evaluation = DataModelEvaluationTrainingPipeline()
